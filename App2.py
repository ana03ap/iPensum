### esto es lo mismo que App.py, solo es para probar la clase de funcionalides
from email.mime import image
import tkinter as tk
from tkinter import Entry, Menu, StringVar
...
def MenuRating(): #Menu de rating zone 
    ...
    tk.Label(ventana, bg = "white", text= string, width = 20, height= 40, font=("Calibri",20,"italic")).place(x=0,y=190)
